...
exports.default = new Controller(_modelDefault.default, _viewDefault.default);
...
class Model {
    ...
    calculate(form, id) {
     ...
     #calcBMR(form) {
        // Get Form Values
        const weightVal = form.querySelector('#weight'), heightFtVal = form.querySelector('#height--ft'), heightInVal = form.querySelector('#height--in'), ageVal = form.querySelector('#age'), genderOptions = form.querySelectorAll('#gender input[type="radio"]'), healthOptions = form.querySelectorAll('#health input[type="radio"]'), height = this.#calcHeight(heightFtVal, heightInVal);
